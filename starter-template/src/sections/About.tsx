...
import simleMemoji from "@/assets/images/memoji-smile.png"
      ...
      <div className="container">
        ...
        <div className="mt-20 flex flex-col gap-8">
          ...
          md:grid-cols-5 lg:grid-cols-3  gap-8">
            ...
            flex-col col-span-3 lg:col-span-2">
              <CardHeader
                title="Beyone the Code"
                description="Explore my interest and hobbies beyon the digital realm."
                className="px-6 py-6"
              />
            ...
            from-emerald-300 to-sky-400 -z-10"></div>
                <Image src={simleMemoji} alt="smiling memoji"
                  className="size-20" />
              </div>
            </Card>
          </div>
